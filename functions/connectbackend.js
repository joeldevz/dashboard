...
export const Sendprinter = async (params) => {
  ...
  let option = {
    business: {
      ...
      info: [
        {
          text: "Gerardo Diego,8 local 8,",
          align: "CENTER",
          width: 1,
          bold: false,
        },
        {
          text: "28806 Alcalá de Henares",
          align: "CENTER",
          width: 1,
          bold: false,
        },
        ...
        {
          text: `FECHA: ${formatoFecha(new Date(), "dd/mm/yyyy")}`,
          align: "CENTER",
          width: 1,
          bold: false,
        },
        {
          text: `Atendido ${getLocalStorage("User")}`,
          align: "CENTER",
          width: 1,
          bold: false,
        },
  ...
  params.products.forEach((product) => {
    ...
    //"ORDENADOR MSI ..."
    option.products.push(
      { text: product.count, align: "LEFT", width: 0.125 },
      { text: labelname, align: "LEFT", width: 0.445 },
      { text: product.price.toFixed(2), align: "RIGHT", width: 0.2 },
      {
        text: (product.price * product.count).toFixed(2),
        align: "RIGHT",
        width: 0.2,
      }
    );
